            ...
            <div className="relative mb-1">
              ...
              {user && String(currentUserId) !== String(room.ownerId) && (
                <button
                  ...
                  className={`absolute -bottom-2 left-1/2 -translate-x-1/2 w-7 h-7 rounded-full flex items-center justify-center border-2 border-white shadow-md transition-all ${
                    isFollowingOwner ? "bg-emerald-500" : "bg-gradient-to-br from-[#2563EB] to-[#38BDF8]"
                  }`}
                >
                  {isFollowingOwner ? (
